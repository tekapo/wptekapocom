...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-wrap wrap clear">
		...
		<footer class="entry-meta">
			...
			<span class="entry-format"><a href="<?php echo esc_url( get_post_format_link( 'gallery' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'ryu' ), get_post_format_string( 'gallery' ) ) ); ?>"><?php echo get_post_format_string( 'gallery' ); ?></a></span>
		...
		<a class="entry-format-badge genericon" href="<?php echo esc_url( get_post_format_link( 'gallery' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'ryu' ), get_post_format_string( 'gallery' ) ) ); ?>"><span class="screen-reader-text"><?php echo get_post_format_string( 'gallery' ); ?></span></a>
	</div><!-- .entry-wrap -->
</article><!-- #post-## -->