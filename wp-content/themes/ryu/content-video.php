...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'clear' ); ?>>
	...
	<div class="entry-wrap wrap clear">
		<div class="entry-info">
			...
			<a class="entry-format-badge genericon" href="<?php echo esc_url( get_post_format_link( 'video' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'ryu' ), get_post_format_string( 'video' ) ) ); ?>"><span class="screen-reader-text"><?php echo get_post_format_string( 'video' ); ?></span></a>
		</div><!-- .entry-info -->
