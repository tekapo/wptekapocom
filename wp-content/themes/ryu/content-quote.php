...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-wrap wrap clear">
		...
		<a class="entry-format-badge genericon" href="<?php echo esc_url( get_post_format_link( 'quote' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'ryu' ), get_post_format_string( 'quote' ) ) ); ?>"><span class="screen-reader-text"><?php echo get_post_format_string( 'quote' ); ?></span></a>
	</div><!-- .entry-wrap -->
</article><!-- #post-## -->